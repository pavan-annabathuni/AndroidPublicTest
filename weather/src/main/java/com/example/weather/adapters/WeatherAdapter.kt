...
class WeatherAdapter(val onClickListener:OnClickListener):androidx.recyclerview.widget.ListAdapter<Daily,WeatherAdapter.ViewHolder>(DiffCallback) {
...
//    }
    ...
    companion object DiffCallback : DiffUtil.ItemCallback<Daily>() {
        ...
        class OnClickListener(val clickListener: (data: Daily) -> Unit) {
            fun onClick(data:Daily) = clickListener(data)
        }
    }
