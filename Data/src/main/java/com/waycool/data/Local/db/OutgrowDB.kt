...
@Database(entities = [TagsEntity::class, CropMasterEntity::class,PestDiseaseEntity::class,CropInformationEntityData::class,MyCropDataEntity::class,AppTranslationsEntity::class,MyFarmsEntity::class,ViewDeviceEntity::class], version = 9, exportSchema = false)
