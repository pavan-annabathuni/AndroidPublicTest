...
@Database(entities = [TagsEntity::class, CropMasterEntity::class,PestDiseaseEntity::class,CropInformationEntityData::class,MyCropDataEntity::class,AppTranslationsEntity::class,MyFarmsEntity::class], version = 7, exportSchema = false)
